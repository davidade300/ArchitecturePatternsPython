...
def test_prefers_earlier_batch():
    earliest = Batch("speedy-batch", "MINIMALIST-SPOON", 100, today)
    medium = Batch("speedy-batch", "MINIMALIST-SPOON", 100, tomorrow)
    latest = Batch("speedy-batch", "MINIMALIST-SPOON", 100, later)
